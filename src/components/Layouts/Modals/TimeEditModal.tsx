    ...
    <Dialog open={isTimeEditModalOpen} onOpenChange={closeModal}>
      <DialogContent className='from-background/95 to-background/80 rounded-3xl border-0 bg-gradient-to-br shadow-2xl backdrop-blur-xl sm:max-w-md'>
        <DialogHeader className='space-y-3 pb-2 text-center'>
          ...
          <DialogTitle className='from-foreground to-foreground/70 bg-gradient-to-r bg-clip-text text-xl font-bold text-transparent'>
            Edit Time
          </DialogTitle>
          <DialogDescription className='from-muted/50 to-muted/30 border-muted-foreground/10 rounded-xl border bg-gradient-to-r px-4 py-2 text-sm font-medium'>
